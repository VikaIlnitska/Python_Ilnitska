from package_3_modules.mod2 import TransLate, LangDetect, CodeLang, LanguageList
...
def main():
    ...
    print(f"Переклад на грецьку: {TransLate(word, 'auto', 'el')}")
    print(f"Переклад на грецьку: {TransLate(word, 'uk', 'greek')}")
